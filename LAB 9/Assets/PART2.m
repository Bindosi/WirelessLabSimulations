...
user1Carriers = effectiveDataCarriers(1:subCarriersPerUser)
user2Carriers = effectiveDataCarriers(subCarriersPerUser+1:2*subCarriersPerUser)
user3Carriers = effectiveDataCarriers(subCarriersPerUser+1:2*subCarriersPerUser)
